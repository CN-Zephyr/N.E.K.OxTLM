...
public class GetPlanHandler implements MessageHandlerInterface {
    @Override
    public JsonObject handle(JsonObject request, WebSocket conn) {
        ...
        String planText = PlanOverlayRenderer.getPlan();
        ...
        responseData.addProperty("plan", planText != null ? planText : "");
